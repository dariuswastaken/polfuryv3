...
export default {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) =>
            option.setName('id').setDescription('ID-ul de discord al persoanei').setRequired(true)
        )
        .addStringOption((option) =>
            option
                .setName('tip')
    ...
    async execute(pulsar, interaction, mongo, utils) {
        ...
        const token = await pulsar.utilsManager.uniques.generateToken(48, tokenType);
