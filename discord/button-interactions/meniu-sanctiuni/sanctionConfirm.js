export default {
    ...
    async execute(pulsar, interaction, mongo, utils) {
        ...
        if (sanction.pending === false) {
            await utils.discord.errors.cannotCreateThreadAgainError(pulsar, interaction);
            return;
        }

        await utils.discord.modals.displaySanctionMotivInputModal(pulsar, interaction, sanctionID);
    }
};
