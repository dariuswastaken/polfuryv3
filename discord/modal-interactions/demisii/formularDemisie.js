export default {
    ...
    async execute(pulsar, interaction, mongo, utils) {
        ...
        const reason = await interaction.fields.getTextInputValue('form-demisie-motiv');
        ...
        const diffInDays = await utils.dayConversion.getDifferenceInDays(dataIntrare, dataDemisie);
