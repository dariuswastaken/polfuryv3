        ...
        Pulsar.client.on('interactionCreate', async (interaction) => {
            ...
            try {
                if (interaction.isUserContextMenuCommand()) {
                    ...
                    console.log(
                        `[CONTEXT MENU EVENT] User context menu command: ${commandName} executed by ${interaction.user.username} on user ${
                ...
                if (interaction.isMessageContextMenuCommand()) {
                    ...
                    console.log(
                        `[CONTEXT MENU EVENT] Message context menu command: ${commandName} executed by ${interaction.user.username} on message ${
