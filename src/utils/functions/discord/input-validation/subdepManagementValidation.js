export const callsignInputSubdep = async ({
    ...
    const callsignInput = interaction.fields.getTextInputValue(`m-instr-${subdep}-callsign-input`);
...
export const callsignInputInstrActivity = async ({ pulsar, interaction, utils, mongo, subdep }) => {
