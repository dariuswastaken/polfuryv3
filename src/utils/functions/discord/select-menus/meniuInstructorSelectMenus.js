export const sendCertificatChoiceMenuCooldown = async ({ pulsar, interaction, targetID }) => {
...
export const sendCooldownCertificatDurationSelect = async ({
    ...
    await pulsar.discordManager.embeds.createDefaultEmbed('Alege durata din meniul de mai jos.', {
