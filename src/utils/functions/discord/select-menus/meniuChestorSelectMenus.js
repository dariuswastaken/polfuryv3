export const sendChestorRankChoiceMenu = async ({ pulsar, interaction, targetID }) => {
    ...
    await pulsar.discordManager.embeds.createDefaultEmbed('Alege un grad din meniul de mai jos.', {
...
export const sendChestorWeekChoiceMenu = async ({
    pulsar,
    interaction,
    mongo,
    customID,
