...
export const selfError = async (pulsar, interaction) => {
    pulsar.discordManager.embeds.createErrorEmbed('Eroare', 'Nu te poti demite singur/a.', {
        interaction: interaction,
        ephemeral: true,
        deferReply: true
    });
...
export const selfUseError = async (pulsar, interaction) => {
    pulsar.discordManager.embeds.createErrorEmbed('Eroare', 'Nu poti folosi acest meniu pe tine.', {
        interaction: interaction,
        ephemeral: true,
        deferReply: true
    });
