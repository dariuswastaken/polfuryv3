...
export const sendUserEditMenu = async ({ pulsar, interaction, targetID }, botconfig) => {
    ...
    await pulsar.discordManager.embeds.createDefaultEmbed('Alege o optiune de mai jos.', {
...
export const sendMenuDeleteUser = async ({ pulsar, interaction, mongo, targetID }, botconfig) => {
