export const displaySanctionCallsignInputModal = async (pulsar, interaction) => {
...
export const displaySanctionMotivInputModal = async (pulsar, interaction, sanctionID) => {
    const modal = await pulsar.discordManager.modals.createModal({
