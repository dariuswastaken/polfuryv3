...
export const calculateActionActivityScore = async (
    ...
    for (let i = 0; i < 21; i++) {
        ...
        let isInRange =
            actionActivity >= rangeActionActivity[i] && actionActivity < rangeActionActivity[i + 1];
        if (isInRange) {
            break;
        }
    }
...
export const gradeAdjust = async (rank, grade, { reports, fines, calls, actionActivity }) => {
