...
module.exports = {
  activity: {
    rule3AM: new nodeSchedule.RecurrenceRule(),
...
module.exports.activity.rule3AM.hour = 3;
module.exports.activity.rule3AM.minute = 0;
...
module.exports.activity.rule3AM.tz = 'Europe/Bucharest';
