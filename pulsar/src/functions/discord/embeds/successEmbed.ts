...
import { CreateSuccessEmbedOptions } from '../../../../interfaces/discord/embeds/successEmbed.interfaces.ts';

export const createSuccessEmbed = async (
    type: string,
    description: string,
    options: CreateSuccessEmbedOptions
): Promise<void> => {
